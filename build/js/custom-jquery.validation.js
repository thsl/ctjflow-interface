...
(function(window, document, $, undefined) {
    ...
    var _messages = {
        'default': '$ contém erros(s).',
        'NOTEMPTY': '$ não pode ser vazio.',
        'INTEGER': '$ deve ser íntegro.',
        'NUMERIC': '$ deve ser numérico.',
        'MIXED': '$ deve conter apenas letras ou números (sem caracteres especiais).',
        'NAME': '$ não deve conter caracteres especiais.',
        'NOSPACE': '$ não pode conter espaços.',
        'TRIM': '$ não pode conter espaços.',
        'DATE': '$ não é um formato válido de data (Dia / Mês / Ano).',
        'EMAIL': '$ não é válido.',
        'URL': '$ não é válido.',
        'PHONE': '$ não é um número válido.',
        '<': '$ deve conter menos de % caracteres.',
